...
import { Users, Award, Globe, TrendingUp, Building2, CheckCircle2, Rocket, Heart, Lightbulb } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="/programs" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-medium hover:opacity-90 transition">
                  Explore Programs <Rocket className="w-4 h-4" />
                </a>
                <a href="/blog" className="inline-flex items-center gap-2 border border-border px-6 py-3 rounded-lg font-medium text-foreground hover:bg-accent transition">
                  Learn More
                </a>
              </div>
              {/* Small badges */}
